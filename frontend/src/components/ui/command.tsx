...
interface ExtendedCommandItemProps extends React.ComponentProps<
...
function CommandItem({
  ...
  return (
    ...
    >
      ...
      <CheckIcon
        className={cn(
          "ml-auto transition-opacity duration-150 text-blue-600",
