...
import { SettlementService } from '../../agent/service/settlement.service.js';
...
export class AssignmentController {
  ...
  /** POST /orders/:publicId/complete */
  complete = async (req: Request, res: Response) => {
    const updated = await this.settlement.settlePickedUp(String(req.params.publicId), req.order!);
    sendSuccess(res, updated, 'order completed');
  };
}
